...
let component = ReasonReact.statelessComponent("Pageinternshipdesign");
...
let make = (_children) => {
  ...
  render: _self => {
    <MainPage>
      <PageHeader title="Internship" subtitle="Art & Design" className="bg-gradient-color1" />
      ...
      <div className="footer-intern bg-gradient-color2"> 
        <div className="container pt-5 pb-4"> 
          <div className="row d-block text-center text-white">
            ...
            <p className="-text-small-title text-color1">{string("*Please include your preferred start and end date of the internship in the email")}</p>
          </div>
        </div>
      </div>
    </MainPage>;
