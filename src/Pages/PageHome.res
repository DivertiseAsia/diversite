...
let make = () => {
  ...
  >
    ...
    <div>
      ...
      <FrontPageSection
        title="Artificial Intelligence" imageURL="/static/images/home-ai-3.png" href=Links.ourwork_link(DataTypes.PortfolioItem.AI)>
        {string(
      ...
      <FrontPageSection
        title="Websites" imageURL="/static/images/home-website.png" href=Links.ourwork_link(DataTypes.PortfolioItem.Other)>
        {string(
      ...
      <FrontPageSection
        title="Virtual Reality" imageURL="/static/images/home-vr.png" href=Links.ourwork_link(DataTypes.PortfolioItem.Other)>
        {string(
      ...
      <FrontPageSection
        title="Games" imageURL="/static/images/home-game.png" href=Links.ourwork_link(DataTypes.PortfolioItem.Other)>
        {string(
