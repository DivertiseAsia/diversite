    ...
    <div className="ourwork_section-header-content bg-gradient-color1">
      ...
      <div className="container page-ourwork_nav nav">
        ...
        <div className="nav-container">
          ...
          <a href=Links.ourwork_ai> {string("AI Project")} </a> /* TODO: onclick should change the class name of the div below to "port-ai" */
          <a href=Links.ourwork_websites> {string("Design Projects")} </a> /* TODO: onclick should change the class name of the div below to "port-app" */
