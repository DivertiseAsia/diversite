...
[@bs.module]
external ourgoal1: string = "../../../../public/images/icon-platforms.png";
[@bs.module]
external ourgoal2: string = "../../../../public/images/icon-ai.png";
[@bs.module]
external ourgoal3: string = "../../../../public/images/icon-vr.png";
[@bs.module]
external homeapp: string = "../../../../public/images/home-app.png";
[@bs.module]
external homeweb: string = "../../../../public/images/home-website.png";
[@bs.module]
external homeai: string = "../../../../public/images/home-ai-3.png";
[@bs.module] external homevr: string = "../../../../public/images/home-vr.png";
[@bs.module]
external homegame: string = "../../../../public/images/home-game.png";
[@bs.module]
external techcon: string = "../../../../public/images/letushelp-tech.png";
[@bs.module]
external optimize: string = "../../../../public/images/letushelp-optimize.png";
[@bs.module]
external launch: string = "../../../../public/images/letushelp-launch.png";
  ...
  <MainPage className="page-home">
    ...
    <div className="section-ourgoal -text-center">
      <div className="container">
        <h3 className="pt-5">
          {string(
             "Our goal is to be the technical partner for startups in Asia",
           )}
        </h3>
    ...
    <div className="section-letushelp">
      <div className="container -text-center">
        <h3 className="-text-uppercase pb-5 pt-5">
          {string("Let Us Help You")}
        </h3>
        <div className="row">
          <div className="col-sm-12 col-md-4 letushelp_col">
            <div>
              <h5> {string("Tech Consultant")} </h5>
              <ImageBackground src=techcon> <div /> </ImageBackground>
              <p>
                {string(
          ...
          <div className="col-sm-12 col-md-4 letushelp_col">
            <div>
              ...
              <ImageBackground src=optimize> <div /> </ImageBackground>
              <p>
                {string(
          ...
          <div className="col-sm-12 col-md-4 letushelp_col">
            <div>
              ...
              <ImageBackground src=launch> <div /> </ImageBackground>
              <p>
                {string(
