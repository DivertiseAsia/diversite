...
function Carousel(Props) {
  ...
  return React.createElement("div", {
              ...
              id: "webgl-background"
                  ...
                  className: "container"
                }, React.createElement("h1", undefined, "Technical partner for startups in Asia"), React.createElement("p", undefined, "specializing in Artificial Intelligence, VR, and other cutting-edge technologies."), React.createElement("div", {
                      className: "btn",
