...
let make = (~className: option<string>=?) => {
  <div className="contactform-container">
    <form
      ...
      <InputText
        type_="text" placeholder="What should we call you?" inputLabel="Your Name" name="name"
      />
      <InputText type_="email" placeholder="Your Email" inputLabel="Your Email" name="email" />
      <InputText
        isTextarea=true
